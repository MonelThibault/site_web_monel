...
foreach($products as $product  => $list ) {
    echo "<div style = 'text-align: center' >";
    echo "<h2>" . $products[$product]["name"] . "</h2>";
//    echo "<h3>" . formatPrice($products[$product]["price"]) . " HT</h3>";
...
//    echo "<h3>" . discountedPrice($products[$product]["price"], $products[$product]["discount"]) . " reduct TTC</h3>";
    echo "<h3>" . $products[$product]["weight"] . " </h3>";
    echo "<img src =' " . $products[$product]["picture_url"] . "' alt=product picture' " . "'>";
    echo "</div>";
}
?>
